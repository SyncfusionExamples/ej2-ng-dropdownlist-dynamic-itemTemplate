...
export class AppComponent {
    ...
    ngAfterViewInit() {        
        // loading the template as a component
        let componentFactory = this.componentResolver.resolveComponentFactory(Newcomponent);
        // Creating component reference for the template
        const ref = this.viewContainerRef.createComponent(componentFactory); 
        // assigning the itemTemplate from template's component reference to the dropdownlist's itemTemplate property
